...
public final class StorageProtos {
  ...
  public interface SessionStructureOrBuilder extends
    ...
    /**
     * <code>optional bytes sessionHashPrevious = 14;</code>
     * @return Whether the sessionHashPrevious field is set.
     */
    boolean hasSessionHashPrevious();
    /**
     * <code>optional bytes sessionHashPrevious = 14;</code>
     * @return The sessionHashPrevious.
     */
    com.google.protobuf.ByteString getSessionHashPrevious();

    /**
     * <code>optional bytes authenticationKey = 15;</code>
     * @return Whether the authenticationKey field is set.
     */
    boolean hasAuthenticationKey();
    /**
     * <code>optional bytes authenticationKey = 15;</code>
     * @return The authenticationKey.
     */
    com.google.protobuf.ByteString getAuthenticationKey();

    /**
     * <code>optional bytes sessionHashCurrent = 16;</code>
     * @return Whether the sessionHashCurrent field is set.
     */
    boolean hasSessionHashCurrent();
    /**
     * <code>optional bytes sessionHashCurrent = 16;</code>
     * @return The sessionHashCurrent.
     */
    com.google.protobuf.ByteString getSessionHashCurrent();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    private SessionStructure() {
      ...
      sessionHashPrevious_ = com.google.protobuf.ByteString.EMPTY;
      authenticationKey_ = com.google.protobuf.ByteString.EMPTY;
      sessionHashCurrent_ = com.google.protobuf.ByteString.EMPTY;
    }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 114: {
              ...
              sessionHashPrevious_ = input.readBytes();
              break;
            }
            case 122: {
              bitField0_ |= 0x00002000;
              authenticationKey_ = input.readBytes();
              break;
            }
            case 130: {
              bitField0_ |= 0x00004000;
              sessionHashCurrent_ = input.readBytes();
              break;
            }
            default: {
  ...
  bitField0_ |= 0x00000004;
    ...
    public static final int SESSIONHASHPREVIOUS_FIELD_NUMBER = 14;
    private com.google.protobuf.ByteString sessionHashPrevious_;
    /**
     * <code>optional bytes sessionHashPrevious = 14;</code>
     * @return Whether the sessionHashPrevious field is set.
     */
    @java.lang.Override
    public boolean hasSessionHashPrevious() {
     ...
     */
    @java.lang.Override
    public com.google.protobuf.ByteString getSessionHashPrevious() {
      return sessionHashPrevious_;
    }

    public static final int AUTHENTICATIONKEY_FIELD_NUMBER = 15;
    private com.google.protobuf.ByteString authenticationKey_;
    /**
     * <code>optional bytes authenticationKey = 15;</code>
     * @return Whether the authenticationKey field is set.
     */
     ...
     */
    @java.lang.Override
    public com.google.protobuf.ByteString getAuthenticationKey() {
      return authenticationKey_;
    }

    public static final int SESSIONHASHCURRENT_FIELD_NUMBER = 16;
    private com.google.protobuf.ByteString sessionHashCurrent_;
    /**
     * <code>optional bytes sessionHashCurrent = 16;</code>
     * @return Whether the sessionHashCurrent field is set.
     */
    @java.lang.Override
    public boolean hasSessionHashCurrent() {
     ...
     */
    @java.lang.Override
    public com.google.protobuf.ByteString getSessionHashCurrent() {
      return sessionHashCurrent_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (((bitField0_ & 0x00001000) != 0)) {
        output.writeBytes(14, sessionHashPrevious_);
      }
      if (((bitField0_ & 0x00002000) != 0)) {
        output.writeBytes(15, authenticationKey_);
      }
      if (((bitField0_ & 0x00004000) != 0)) {
        output.writeBytes(16, sessionHashCurrent_);
      }
      unknownFields.writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (((bitField0_ & 0x00001000) != 0)) {
        size += com.google.protobuf.CodedOutputStream
          .computeBytesSize(14, sessionHashPrevious_);
      }
      if (((bitField0_ & 0x00002000) != 0)) {
        size += com.google.protobuf.CodedOutputStream
          .computeBytesSize(15, authenticationKey_);
      }
      if (((bitField0_ & 0x00004000) != 0)) {
        size += com.google.protobuf.CodedOutputStream
          .computeBytesSize(16, sessionHashCurrent_);
      }
      size += unknownFields.getSerializedSize();
      memoizedSize = size;
      return size;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (hasSessionHashPrevious() != other.hasSessionHashPrevious()) return false;
      if (hasSessionHashPrevious()) {
        if (!getSessionHashPrevious()
            .equals(other.getSessionHashPrevious())) return false;
      }
      if (hasAuthenticationKey() != other.hasAuthenticationKey()) return false;
      if (hasAuthenticationKey()) {
        if (!getAuthenticationKey()
            .equals(other.getAuthenticationKey())) return false;
      }
      if (hasSessionHashCurrent() != other.hasSessionHashCurrent()) return false;
      if (hasSessionHashCurrent()) {
        if (!getSessionHashCurrent()
            .equals(other.getSessionHashCurrent())) return false;
      }
      if (!unknownFields.equals(other.unknownFields)) return false;
      return true;
    }
    ...
    public int hashCode() {
      ...
      if (hasSessionHashPrevious()) {
        hash = (37 * hash) + SESSIONHASHPREVIOUS_FIELD_NUMBER;
        hash = (53 * hash) + getSessionHashPrevious().hashCode();
      }
      if (hasAuthenticationKey()) {
        hash = (37 * hash) + AUTHENTICATIONKEY_FIELD_NUMBER;
        hash = (53 * hash) + getAuthenticationKey().hashCode();
      }
      if (hasSessionHashCurrent()) {
        hash = (37 * hash) + SESSIONHASHCURRENT_FIELD_NUMBER;
        hash = (53 * hash) + getSessionHashCurrent().hashCode();
      }
      hash = (29 * hash) + unknownFields.hashCode();
      memoizedHashCode = hash;
      return hash;
    ...
    public static final class Builder extends
      ...
      public org.whispersystems.libsignal.state.StorageProtos.SessionStructure buildPartial() {
        ...
        result.sessionHashPrevious_ = sessionHashPrevious_;
        ...
        result.sessionHashCurrent_ = sessionHashCurrent_;
        result.bitField0_ = to_bitField0_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(org.whispersystems.libsignal.state.StorageProtos.SessionStructure other) {
        ...
        if (other.hasSessionHashPrevious()) {
          setSessionHashPrevious(other.getSessionHashPrevious());
        }
        if (other.hasAuthenticationKey()) {
          setAuthenticationKey(other.getAuthenticationKey());
        }
        if (other.hasSessionHashCurrent()) {
          setSessionHashCurrent(other.getSessionHashCurrent());
        }
        this.mergeUnknownFields(other.unknownFields);
        onChanged();
        return this;
  ...
  bitField0_ |= 0x00001000;
      ...
      private com.google.protobuf.ByteString sessionHashPrevious_ = com.google.protobuf.ByteString.EMPTY;
      /**
       * <code>optional bytes sessionHashPrevious = 14;</code>
       * @return Whether the sessionHashPrevious field is set.
       */
      ...
      /**
       * <code>optional bytes sessionHashPrevious = 14;</code>
       * @param value The sessionHashPrevious to set.
       * @return This builder for chaining.
       */
      public Builder setSessionHashPrevious(com.google.protobuf.ByteString value) {
        if (value == null) {
    throw new NullPointerException();
  }
  bitField0_ |= 0x00002000;
        sessionHashPrevious_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearSessionHashPrevious() {
        bitField0_ = (bitField0_ & ~0x00002000);
        sessionHashPrevious_ = getDefaultInstance().getSessionHashPrevious();
        onChanged();
        return this;
      }

      private com.google.protobuf.ByteString authenticationKey_ = com.google.protobuf.ByteString.EMPTY;
      /**
       * <code>optional bytes authenticationKey = 15;</code>
       * @return Whether the authenticationKey field is set.
       */
      ...
      /**
       * <code>optional bytes authenticationKey = 15;</code>
       * @param value The authenticationKey to set.
       * @return This builder for chaining.
       */
      public Builder setAuthenticationKey(com.google.protobuf.ByteString value) {
        if (value == null) {
    throw new NullPointerException();
  }
  bitField0_ |= 0x00004000;
      ...
      private com.google.protobuf.ByteString sessionHashCurrent_ = com.google.protobuf.ByteString.EMPTY;
      /**
       * <code>optional bytes sessionHashCurrent = 16;</code>
       * @return Whether the sessionHashCurrent field is set.
       */
      ...
      /**
       * <code>optional bytes sessionHashCurrent = 16;</code>
       * @param value The sessionHashCurrent to set.
       * @return This builder for chaining.
       */
      public Builder setSessionHashCurrent(com.google.protobuf.ByteString value) {
        if (value == null) {
    throw new NullPointerException();
  }
  bitField0_ |= 0x00008000;
        sessionHashCurrent_ = value;
        onChanged();
        return this;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder clearSessionHashCurrent() {
        bitField0_ = (bitField0_ & ~0x00008000);
        sessionHashCurrent_ = getDefaultInstance().getSessionHashCurrent();
        onChanged();
        return this;
      }
      @java.lang.Override
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "sh\030\014 \001(\010\022\024\n\014aliceBaseKey\030\r \001(\014\022\033\n\023sessio" +
      "nHashPrevious\030\016 \001(\014\022\031\n\021authenticationKey" +
      "\030\017 \001(\014\022\032\n\022sessionHashCurrent\030\020 \001(\014\032\271\002\n\005C" +
      ...
      "hetKeyPrivate\030\005 \001(\014\022\030\n\020localIdentityKey\030" +
      "\007 \001(\014\022\037\n\027localIdentityKeyPrivate\030\010 \001(\014\032J" +
      "\n\rPendingPreKey\022\020\n\010preKeyId\030\001 \001(\r\022\026\n\016sig" +
      "nedPreKeyId\030\003 \001(\005\022\017\n\007baseKey\030\002 \001(\014\"\177\n\017Re" +
      "cordStructure\0224\n\016currentSession\030\001 \001(\0132\034." +
      "textsecure.SessionStructure\0226\n\020previousS" +
      "essions\030\002 \003(\0132\034.textsecure.SessionStruct" +
      "ure\"J\n\025PreKeyRecordStructure\022\n\n\002id\030\001 \001(\r" +
      "\022\021\n\tpublicKey\030\002 \001(\014\022\022\n\nprivateKey\030\003 \001(\014\"" +
      "v\n\033SignedPreKeyRecordStructure\022\n\n\002id\030\001 \001" +
      "(\r\022\021\n\tpublicKey\030\002 \001(\014\022\022\n\nprivateKey\030\003 \001(" +
      "\014\022\021\n\tsignature\030\004 \001(\014\022\021\n\ttimestamp\030\005 \001(\006\"" +
      "A\n\030IdentityKeyPairStructure\022\021\n\tpublicKey" +
      "\030\001 \001(\014\022\022\n\nprivateKey\030\002 \001(\014\"\270\003\n\027SenderKey" +
      "StateStructure\022\023\n\013senderKeyId\030\001 \001(\r\022J\n\016s" +
      "enderChainKey\030\002 \001(\01322.textsecure.SenderK" +
      "eyStateStructure.SenderChainKey\022N\n\020sende" +
      "rSigningKey\030\003 \001(\01324.textsecure.SenderKey" +
      "StateStructure.SenderSigningKey\022O\n\021sende" +
      "rMessageKeys\030\004 \003(\01324.textsecure.SenderKe" +
      "yStateStructure.SenderMessageKey\0321\n\016Send" +
      "erChainKey\022\021\n\titeration\030\001 \001(\r\022\014\n\004seed\030\002 " +
      "\001(\014\0323\n\020SenderMessageKey\022\021\n\titeration\030\001 \001" +
      "(\r\022\014\n\004seed\030\002 \001(\014\0323\n\020SenderSigningKey\022\016\n\006" +
      "public\030\001 \001(\014\022\017\n\007private\030\002 \001(\014\"X\n\030SenderK" +
      "eyRecordStructure\022<\n\017senderKeyStates\030\001 \003" +
      "(\0132#.textsecure.SenderKeyStateStructureB" +
      "3\n\"org.whispersystems.libsignal.stateB\rS" +
      "torageProtos"
    };
    ...
    internal_static_textsecure_SessionStructure_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_textsecure_SessionStructure_descriptor,
        new java.lang.String[] { "SessionVersion", "LocalIdentityPublic", "RemoteIdentityPublic", "RootKey", "PreviousCounter", "SenderChain", "ReceiverChains", "PendingKeyExchange", "PendingPreKey", "RemoteRegistrationId", "LocalRegistrationId", "NeedsRefresh", "AliceBaseKey", "SessionHashPrevious", "AuthenticationKey", "SessionHashCurrent", });
    internal_static_textsecure_SessionStructure_Chain_descriptor =
